...
@Service
@Slf4j
public class ClientServiceImplSecurityOAuth implements ClientService {
    ...
    public ClientServiceImplSecurityOAuth(ClientRepository repository, ClientMapper mapper, PasswordEncoder passwordEncoder, ClientValidationService validationService) {
